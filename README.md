...
| [`modules/frontend.md`](migrate-spring-to-liberty/modules/frontend.md) | View layer migration (Thymeleaf → JSF 4.1 / JSP, static assets, CSRF removal) |
| [`modules/testing.md`](migrate-spring-to-liberty/modules/testing.md) | Test migration (MicroShed Testing, JUnit 5, Mockito, REST Assured) |
